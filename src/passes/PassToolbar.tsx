...
export function PassToolbar({
  ...
  return (
    <div className="pass-toolbar" aria-label="Fragment passes">
      <div className="pass-tabs" role="tablist" aria-label="Ordered fragment passes">
        {passes.map((pass, index) => (
          <button
            type="button"
            role="tab"
            key={pass.id}
            aria-selected={pass.id === activePassId}
            className={pass.id === activePassId ? "active" : ""}
